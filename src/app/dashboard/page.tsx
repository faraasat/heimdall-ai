...
export default async function DashboardPage() {
  ...
  const totalFindings =
    scans?.reduce((sum, scan) => sum + (scan.findings_count || 0), 0) || 0;
    ...
    <div className="container mx-auto px-4 py-8 relative">
      ...
      <div className="mb-8 animate-fade-in-up">
        ...
        <p className="text-gray-400">
          Here's your security overview at a glance.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link
            ...
            className="group animate-fade-in-up delay-400"
          >
          ...
          <Link
            ...
            className="group animate-fade-in-up delay-500"
          >
          ...
          <Link
            ...
            className="group animate-fade-in-up delay-600"
          >
            <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm hover:border-gray-700 transition-all duration-300 h-full group-hover:scale-105 group-hover:shadow-xl cursor-pointer">
              <CardHeader>
                <div className="flex items-center gap-3">
        ...
        <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm md:col-span-1 animate-fade-in-up delay-700">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Progress
                value={Math.max(50, 100 - totalFindings * 2)}
                className="h-2"
              />
              ...
              {scans &&
                scans.slice(0, 3).map((scan, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-2 h-2 rounded-full ${scan.status === "running" ? "bg-blue-400 animate-pulse" : scan.status === "completed" ? "bg-green-400" : "bg-red-400"}`}
                      />
                      <div>
                    ...
                    <Badge
                      variant="outline"
                      className={`${scan.status === "running" ? "border-blue-500 text-blue-400" : scan.status === "completed" ? "border-green-500 text-green-400" : "border-red-500 text-red-400"}`}
                    >
                      {scan.status}
                    </Badge>
                  </div>
